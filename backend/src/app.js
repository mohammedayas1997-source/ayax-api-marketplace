...
const dataRoutes = require(
  "./routes/data.routes"
);

const airtimeRoutes = require(
...
const commandRoutes = require(
  "./routes/command.routes"
);

const adminNotificationRoutes = require(
  "./routes/adminNotification.routes"
);
  ...
  (
    ...
    if (
      ...
      error?.message?.includes(
        "not permitted to access the API"
      )
    ) {
      return res.status(403).json({
        ...
        message:
          "This website is not permitted to access the API.",

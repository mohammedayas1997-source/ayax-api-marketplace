...
const refundRoutes =
  require("./routes/refund.routes");

const supportRoutes =
  require("./routes/support.routes");

const pricingRoutes =
  require("./routes/pricing.routes");

const purchaseRoutes =
  require("./routes/purchase.routes");

const gsmRoutes =
  require("./routes/gsm.routes");
...
const airtimeRoutes =
  require("./routes/airtime.routes");

const walletRoutes =
  require("./routes/wallet.routes");

const apiPlanRoutes =
  require("./routes/apiPlan.routes");
...
const networkProfileRoutes =
  require("./routes/networkProfile.routes");
...
const apiMarketplaceDashboardRoutes =
  require(

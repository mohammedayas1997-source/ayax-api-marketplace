...
import { Menu, X, Bell, User, Headphones } from "lucide-react";
import CustomerServiceSidebar from "@/components/sidebars/CustomerServiceSidebar";

export default function CustomerServiceLayout({ children, title, description }) {
        ...
        {open && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            <div className="relative w-72 max-w-[90%]">
              ...
              <CustomerServiceSidebar onClose={() => setOpen(false)} />
            </div>
          </div>
        )}

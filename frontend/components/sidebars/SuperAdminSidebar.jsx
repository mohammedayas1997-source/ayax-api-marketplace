...
const links = [
...

  {
    ...
    href: "/super-admin/customer-service",
    icon: Headphones,
  },
...

  {
    ...
    href: "/super-admin/gsm/security-alerts",
    icon: ShieldAlert,
  },

  {
    name: "Live Location",
    href: "/super-admin/gsm/live-location",
    icon: MapPin,
  },
  ...
  {
    name: "Usage Logs",
    href: "/super-admin/api-marketplace/usage",
    icon: Activity,
  },

  {
    name: "Webhooks",
    href: "/super-admin/api-marketplace/webhooks",
    icon: Server,
  },
...

  {
    ...
    href: "/super-admin/gateway-devices",
    icon: Smartphone,
  },
  ...
  {
    name: "Incoming SMS",
    href: "/super-admin/gsm/sms-inbox",
    icon: MessageSquare,
  },
